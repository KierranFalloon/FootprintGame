...
def main():
    ...
    w, t, r = read_stats()
    def new_pokemon():
        global pokemon_1, pokemon_2, pokemon_3, pokemon_4, name1, name2, name3, name4, footprint_image
        # Pokemon footprint definition
        footprint = random.choice(get_pokemon())
        print(footprint)
        footprint_image = pygame.image.load(os.path.join('Sprites', str(footprint)+'.png')).convert_alpha()
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                try:
                    ...
                    if pokemon_list[pokemon_clicked].correct == True:
                        w += 1
                        t += w
                        pokemon_list[pokemon_clicked].presesd = True
